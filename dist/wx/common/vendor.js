...
var baseUrl = 'http://www.kxzeus.com/zues/api';
...
function cookieMock(cookies) {
    ...
    cookies = cookies.filter(function (cookie) {
        return new Date(cookie.expires).getTime() - Date.now() >= 0;
    });
    return cookies.reduce(function (a, b) {
...
function parseCookie(cookies) {
    ...
    return cookiesArray.map(function (item) {
        if (!item.includes('GMT')) item = item + 'GMT';
        var obj = {};
        var itemArray = item.split(';');
        itemArray.forEach(function (subItem, index) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
        wx.request({
            ...
            success: function success(response) {
                ...
                var cookiesParse = parseCookie(response.header['set-cookie'] || response.header['Set-Cookie']);
                if (cookiesParse && cookiesParse.length > 0) {
                    cookiesParse.forEach(function (item) {
                        var index = -1;
                        cookies.forEach(function (item2, idx) {
                            if (item2.name === item.name) index = idx;
                        });
                        if (index !== -1) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return specList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return typeList; });
var specList = [['20', '25', '30', '40', '50', '60', '70', '80', '90', '100', '200'], ['20', '25', '30', '40', '50', '60', '70', '80', '90', '100', '200'], ['1.00', '1.25', '1.50', '1.75', '2.00', '2.25', '2.50', '2.75', '3.00', '3.25', '3.50', '3.75', '4.00', '4.25', '4.50', '4.75', '5.00', '5.25', '5.50', '5.75', '6.00', '6.50', '7.00', '7.50', '8.00', '8.50', '9.00', '9.50', '10.00', '10.50', '11.00']];

var typeList = ['黑管', '热镀锌', '镀锌带'];
...
/* harmony export (immutable) */ __webpack_exports__["b"] = formatGutter;
...
function formatGutter(timestamp) {
  ...
  days = days % 30;
  return '' + (months != 0 ? months + '个月' : '') + ('' + (days != 0 ? days + '天' : '')) + ('' + (hours != 0 ? hours + '小时' : '')) + ('' + (minutes != 0 ? minutes + '分钟' : ''));
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-6b62678f"
/* moduleIdentifier (server only) */
...
Component.options.__file = "src/components/demand-item.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] demand-item.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6b62678f", Component.options)
  } else {
    hotAPI.reload("data-v-6b62678f", Component.options)
  }
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-66c7007e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-66c7007e", Component.options)
  } else {
    hotAPI.reload("data-v-66c7007e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dialog__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_request__ = __webpack_require__(4);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    components: {
        'x-dialog': __WEBPACK_IMPORTED_MODULE_1__dialog__["a" /* default */]
    },

    computed: {
        stateFormat: function stateFormat() {
        ...
        classFormat: function classFormat() {
            if (!this.data.state && this.data.state !== 0) return '';
            var states = {
                '0': 'unprice',
                '1': 'submit',
        ...
        createTimeFormat: function createTimeFormat() {
            return this.timeFormat(this.data.createTime);
        },
        priceTimeFormat: function priceTimeFormat() {
            var gutter = Object(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* formatGutter */])(this.data.priceTime - this.data.createTime);
            return this.timeFormat(this.data.priceTime) + ('\uFF08' + gutter + '\uFF09');
        },
        feedbackTimeFormat: function feedbackTimeFormat() {
            var gutter = Object(__WEBPACK_IMPORTED_MODULE_0__utils__["b" /* formatGutter */])(this.data.feedbackTime - this.data.createTime);
    ...
    methods: {
        timeFormat: function timeFormat(timestamp) {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_0__utils__["c" /* formatTime */])(date);
        },
        viewDemandDetail: function viewDemandDetail(data) {
            var _this = this;

            wx.showLoading({ title: '加载中' });
            Object(__WEBPACK_IMPORTED_MODULE_2__utils_request__["a" /* default */])({
                url: '/demand/detail',
                data: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-66c7007e", esExports)
  }
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "demand-item"
  }, [_c('div', {
    staticClass: "title"
  }, [_c('text', {
    staticClass: "demand-no"
  }, [_vm._v(_vm._s(_vm.data.demandNo))]), _vm._v(" "), _c('text', {
    staticClass: "demand-state",
    class: _vm.classFormat
  }, [_vm._v("(" + _vm._s(_vm.stateFormat) + ")：")]), _vm._v(" "), _c('text', {
    staticClass: "demand-tips"
  }, [_vm._v("(报价有效期为半天，提供全款锁价服务，以款到时间为准；重量为理算重量，以实际过磅为准，直发需满30吨)")])]), _vm._v(" "), _c('div', {
    staticClass: "demand-detail"
  }, [_c('div', {
    staticClass: "demand-line"
  }, [_c('text', {
    staticClass: "detail-label"
  }, [_vm._v("创建时间")]), _vm._v(" "), _c('text', {
    staticClass: "detail-value"
  }, [_vm._v(_vm._s(_vm.createTimeFormat))])]), _vm._v(" "), (_vm.data.priceTime) ? _c('div', {
    staticClass: "demand-line"
  }, [_c('text', {
    staticClass: "detail-label"
  }, [_vm._v("报价时间")]), _vm._v(" "), _c('text', {
    staticClass: "detail-value"
  }, [_vm._v(_vm._s(_vm.priceTimeFormat))])]) : _vm._e(), _vm._v(" "), (_vm.data.feedbackTime) ? _c('div', {
    staticClass: "demand-line"
  }, [_c('text', {
    staticClass: "detail-label"
  }, [_vm._v("反馈时间")]), _vm._v(" "), _c('text', {
    staticClass: "detail-value"
  }, [_vm._v(_vm._s(_vm.feedbackTimeFormat))])]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "demand-line"
  }, [_c('text', {
    staticClass: "detail-label"
  }, [_vm._v("销售")]), _vm._v(" "), _c('text', {
    staticClass: "detail-value"
  }, [_vm._v(_vm._s(_vm.data.userId))])]), _vm._v(" "), (_vm.data.customerName) ? _c('div', {
    staticClass: "demand-line"
  }, [_c('text', {
    staticClass: "detail-label"
  }, [_vm._v("客户")]), _vm._v(" "), _c('text', {
    staticClass: "detail-value"
  }, [_vm._v(_vm._s(_vm.data.customerName))])]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "demand-line"
  }, [_c('text', {
    staticClass: "detail-label"
  }, [_vm._v("采购")]), _vm._v(" "), _c('text', {
    staticClass: "detail-value"
  }, [_vm._v(_vm._s(_vm.data.priceUser))])]), _vm._v(" "), (_vm.data.demandWeight) ? _c('div', {
    staticClass: "demand-line"
  }, [_c('text', {
    staticClass: "detail-label"
  }, [_vm._v("总重量")]), _vm._v(" "), _c('text', {
    staticClass: "detail-value"
  }, [_vm._v(_vm._s(_vm.data.demandWeight) + "吨")])]) : _vm._e(), _vm._v(" "), (_vm.data.comment) ? _c('div', {
    staticClass: "demand-line"
  }, [_c('text', {
    staticClass: "detail-label"
  }, [_vm._v("备注")]), _vm._v(" "), _c('text', {
    staticClass: "detail-value comment"
  }, [_vm._v(_vm._s(_vm.data.comment))])]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "demand-line"
  }, [_c('text', {
    staticClass: "detail-label"
  }, [_vm._v("需求详情")]), _vm._v(" "), _c('text', {
    staticClass: "detail-value detail",
    attrs: {
      "eventid": '0'
    },
    on: {
      "tap": function($event) {
        _vm.viewDemandDetail(_vm.data)
      }
    }
  }, [_vm._v("查看详情")])])]), _vm._v(" "), _c('x-dialog', {
    attrs: {
      "visible": _vm.visible,
      "eventid": '1',
      "mpcomid": '0'
    ...
    return _c('div', {
      key: index,
      staticClass: "demand-detail-line"
    }, [_c('div', {
    ...
    }, [_vm._v(_vm._s(item.demandAmount))]), _vm._v(" "), _c('div', {
      staticClass: "data weight"
    }, [_vm._v(_vm._s(item.demandWeight) + "吨")]), _vm._v(" "), _c('div', {
      staticClass: "data price"
    }, [_vm._v(_vm._s(item.feedbackPrice))]), _vm._v(" "), _c('div', {
      staticClass: "data factory"
    }, [_vm._v(_vm._s(item.factoryPrice))]), _vm._v(" "), _c('div', {
      staticClass: "data freight"
    }, [_vm._v(_vm._s(item.freight))])])
  }))])])], 1)
}
var staticRenderFns = []
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6b62678f", esExports)
  }
}
